...
class MetroApp {
  ...
  void _searchInManyLines() {
    ...
    } else if (_metroLine1.contains(start) && _cairoKitKateBranch.contains(end)) {
      _searchRoutesFromLine1ToCairoKitKateBranch();
    } else if (_cairoKitKateBranch.contains(start) && _metroLine1.contains(end)) {
      _searchRoutesFromCairoKitKateBranchToLine1();
    } else if (_metroLine2.contains(start) && _cairoKitKateBranch.contains(end)) {
      _searchRoutesFromLine2ToCairoKitKateBranch();
    } else if (_cairoKitKateBranch.contains(start) && _metroLine2.contains(end)) {
  ...
  void _searchRoutesFromCairoKitKateBranchToLine2() {
    ...
    if (endIndex < attabaIndexAtLine2) {
      _directionForFirstRoute.write('Then Take Direction to ShobraEl-Kheimar  ');
      subLine = _metroLine2
    ...
    _directionForSecondRoute.write('Change Direction to Cairo University ');
    cairoLine.addAll(_cairoKitKateBranch.sublist(
        startIndex, cairoUniversityIndexAtCairoBranch + 1));
    if (endIndex < cairoIndexAtLine2) {
      _directionForSecondRoute.write('Then Take Direction to ShobraEl-Kheimaa');
      subLine =
          _metroLine2
              .sublist(endIndex, cairoIndexAtLine2)
              .reversed
              .toList();
      ...
      cairoLine.addAll(_metroLine2.sublist(cairoIndexAtLine2 + 1, endIndex + 1));
    }
  ...
  void _searchRoutesFromCairoKitKateBranchToLine1() {
    final startIndex = _cairoKitKateBranch.indexOf(start);
    final cairoIndexAtKitKatCairoUniversityBranch = _cairoKitKateBranch.indexOf(
        "CairoUniversity");
    final kitKateIndexAtCairoBranch = _cairoKitKateBranch.indexOf("KitKate");
    ...
    if (cairoIndexAtLine2 < sadatIndexAtLine2) {
      ...
      subLine.addAll(_metroLine2
          .sublist(sadatIndexAtLine2, cairoIndexAtLine2)
          .reversed);
      sadatLine.addAll(subLine);
      subLine.clear();
    }
    _directionForSecondRoute.write(
        "then Take Direction to ShobraEl-Kheima and Change Direction at Sadat   ");
    ...
    if (endIndexAtLine1 > sadatIndexAtLine1) {
      sadatLine.addAll(
          _metroLine1.sublist(sadatIndexAtLine1, endIndexAtLine1 + 1));
      ...
      subLine.addAll(_metroLine1
          .sublist(endIndexAtLine1, sadatIndexAtLine1 + 1)
          .reversed);
      sadatLine.addAll(subLine);
      subLine.clear();
    }
    ...
    if (endIndexAtLine1 > nasserIndexAtLine1) {
      ...
      nasserLine.addAll(
          _metroLine1.sublist(nasserIndexAtLine1, endIndexAtLine1 + 1));
  ...
  void _searchRoutesFromLine1ToCairoKitKateBranch() {
    ...
    if (startIndex < nasserIndexAtLine1 && startIndex < sadatIndexAtLine1) {
      _directionForFirstRoute.write(
          "Take Direction to El-Marg and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
          "Take Direction to El-Marg and Change Direction at El-Sadat ");
    ...
    if (startIndex > nasserIndexAtLine1 && startIndex > sadatIndexAtLine1) {
      _directionForFirstRoute.write(
          "Take Direction to Helwan and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
          "Take Direction to Helwan and Change Direction at El-Sadat ");
      ...
      if (startIndex == nasserIndexAtLine1) {
        ...
        nasserLine.addAll(
            _metroLine1.sublist(sadatIndexAtLine1, nasserIndexAtLine1));
        _directionForSecondRoute.write("You are At Sadat");
      }
    }
    ...
    int cairoIndexAtCairoKitKateBranch = _cairoKitKateBranch.indexOf(
        "CairoUniversity");
    ...
    nasserLine.addAll(subLine);
    subLine.clear();
    int kitKateIndexAtCairoKitKateBranch = _cairoKitKateBranch.indexOf(
        "KitKate");
  ...
  void _searchRoutesFromLine1ToLine3() {
    ...
    if (startIndex < nasserIndexAtLine1 && startIndex < sadatIndexAtLine1) {
      _directionForFirstRoute.write(
          "Take Direction to El-Marg and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
          "Take Direction to El-Marg and Change Direction at El-Sadat Then Take Direction to El Mounib And Change Direction at CairoUniversity");
      nasserLine.addAll(_metroLine1.sublist(startIndex, nasserIndexAtLine1));
      sadatLine.addAll(_metroLine1.sublist(startIndex, sadatIndexAtLine1));
    } else
    if (startIndex > nasserIndexAtLine1 && startIndex > sadatIndexAtLine1) {
      _directionForFirstRoute.write(
          "Take Direction to Helwan and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
          "Take Direction to Helwan and Change Direction at El-Sadat Then Take Direction to El Mounib And Change Direction at CairoUniversity");
      subLine.addAll(_metroLine1.sublist(sadatIndexAtLine1 + 1, startIndex));
      subLine = subLine.reversed.toList();
      sadatLine.addAll(subLine);
      subLine.clear();
    ...
    if (endIndex > nasserIndexAtLine3 && endIndex > kitKateIndex) {
      ...
      _directionForFirstRoute.write(
          "And then Take Direction to Road El FargCorr");
      _directionForSecondRoute.write(
          "And then Take Direction to Road El FargCorr");
  ...
  void _searchRoutesFromLine3ToLine1() {
    ...
    if (startIndex < nasserIndexAtLine3 && startIndex < kitKateIndex) {
      _directionForFirstRoute.write(
          "Take Direction to Adly Mansour and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
      ...
      _directionForFirstRoute.write(
          "Take Direction to Road El FargCorr and Change Direction at El-Nasser ");
      _directionForSecondRoute.write(
      ...
      subLine.clear();
      subLine.addAll(
          _metroLine3.sublist(nasserIndexAtLine3 + 1, startIndex + 1));
      subLine = subLine.reversed.toList();
      nasserLine.addAll(subLine);
    } else {
    ...
    int cairoIndexAtLine2 = _metroLine2.indexOf("CairoUniversity");
    kitKateLine.addAll(
        _metroLine2.sublist(sadatIndexAtLine2, cairoIndexAtLine2));
    subLine.addAll(_cairoKitKateBranch);
    subLine = subLine.reversed.toList();
    kitKateLine.addAll(subLine);
    subLine.clear();
    ...
    if (endIndex > nasserIndexAtLine1 && endIndex > sadatIndexAtLine1) {
      ...
      kitKateLine.addAll(
          _metroLine1.sublist(sadatIndexAtLine1 + 1, endIndex + 1));
  ...
  void _searchRoutesFromLine2ToLine3() {
    ...
    // Operations at line 2
    if (startIndex < attabaIndexAtLine2 && startIndex < cairoIndexAtLine2) {
      directionForFirstRoute.write("Take Direction to El-Mounib and Change Direction at El-Attaba\n");
      directionForSecondRoute.write("Take Direction to El-Mounib and Change Direction at CairoUniversity\nAnd Change Direction at KitKate");
      attabaLine.addAll(_metroLine2.sublist(startIndex, attabaIndexAtLine2));
      cairoLine.addAll(_metroLine2.sublist(startIndex, cairoIndexAtLine2));
      subLine.addAll(_cairoKitKateBranch);
      subLine = subLine.reversed.toList();
      ...
      directionForFirstRoute.write("Take Direction to ShobraEl-Kheima and Change Direction at El-Attaba\n");
      directionForSecondRoute.write("Take Direction to ShobraEl-Kheima and Change Direction at CairoUniversity\nAnd Change Direction at KitKate");
      subLine.addAll(_metroLine2.sublist(attabaIndexAtLine2 + 1, startIndex + 1));
      subLine = subLine.reversed.toList();
      attabaLine.addAll(subLine);
      subLine.clear();
      subLine.addAll(_metroLine2.sublist(cairoIndexAtLine2 + 1, startIndex + 1));
      subLine = subLine.reversed.toList();
      cairoLine.addAll(subLine);
      subLine.addAll(_cairoKitKateBranch);
      subLine = subLine.reversed.toList();
    ...
    if (endIndex > attabaIndexAtLine3 && endIndex > kitKateIndex) {
      ...
      directionForFirstRoute.write("And then Take Direction to Road El FargCorr");
      directionForSecondRoute.write("And then Take Direction to Road El FargCorr");
  ...
  void _searchRoutesFromLine3ToLine2() {
    ...
    if (startIndex < attabaIndexAtLine3 && startIndex < kitKateIndex) {
      attabaLine.addAll(_metroLine3.sublist(startIndex, attabaIndexAtLine3 + 1));
      kitKateLine.addAll(_metroLine3.sublist(startIndex, kitKateIndex + 1));
      directionForFirstRoute.write("Take Direction to Adly Mansour and Change Direction at Attaba \n");
      directionForSecondRoute.write("Take Direction to Adly Mansour and Change Direction at KitKate \n");
    } else if (startIndex > attabaIndexAtLine3 && startIndex > kitKateIndex) {
      attabaLine.addAll(_metroLine3.sublist(attabaIndexAtLine3 + 1, startIndex + 1).reversed);
      kitKateLine.addAll(_metroLine3.sublist(kitKateIndex + 1, startIndex + 1).reversed);
      directionForFirstRoute.write("Take Direction to Road El FargCorr and Change Direction at Attaba \n");
      directionForSecondRoute.write("Take Direction to Road El FargCorr and Change Direction at KitKate \n");
      ...
      if (startIndex == attabaIndexAtLine3) {
        directionForFirstRoute.write("You are at Attaba ");
        directionForSecondRoute.write("Take Direction to Road El FargCorr and Change Direction at KitKate ");
        subLine.addAll(_metroLine3.sublist(kitKateIndex + 1, startIndex + 1).reversed);
        kitKateLine.addAll(subLine);
        subLine.clear();
        kitKateLine.addAll(_cairoKitKateBranch);
      } else {
        directionForFirstRoute.write("Take Direction to Adly Mansour and Change Direction at Attaba ");
        directionForSecondRoute.write("You are at KitKate, Then Change Direction at CairoUniversity\n");
        attabaLine.addAll(_metroLine3.sublist(kitKateIndex, attabaIndexAtLine3));
        kitKateLine.addAll(_cairoKitKateBranch);
      }
    }
    ...
    if (endIndex < attabaIndexAtLine2 && endIndex < cairoIndexAtLine2) {
      subLine.addAll(_metroLine2.sublist(endIndex, attabaIndexAtLine2 + 1).reversed);
      attabaLine.addAll(subLine);
      subLine.clear();
      subLine.addAll(_metroLine2.sublist(endIndex, cairoIndexAtLine2 + 1).reversed);
      kitKateLine.addAll(subLine);
      subLine.clear();
      directionForFirstRoute.write("And Then Take Direction to ShobraEl-Kheima ");
      directionForSecondRoute.write("And Then Take Direction to ShobraEl-Kheima ");
    } else if (endIndex > attabaIndexAtLine2 && endIndex > cairoIndexAtLine2) {
      attabaLine.addAll(_metroLine2.sublist(attabaIndexAtLine2, endIndex + 1));
      kitKateLine.addAll(_metroLine2.sublist(cairoIndexAtLine2 + 1, endIndex + 1));
  ...
  void _searchRoutesFromLine1ToLine2() {
    ...
    if (startIndex < sadatIndexAtLine1 && startIndex < shohadaaIndexAtLine1) {
      sadatLine.addAll(_metroLine1.sublist(startIndex, sadatIndexAtLine1));
      shohadaaLine.addAll(_metroLine1.sublist(startIndex, shohadaaIndexAtLine1));
      directionForFirstRoute.writeln("Take Direction to El-Marg and Change Direction at El-Sadat");
      directionForSecondRoute.writeln("Take Direction to El-Marg and Change Direction at El-Shohadaa");
      ...
      shohadaaLine.addAll(_metroLine1.sublist(shohadaaIndexAtLine1 + 1, startIndex));
      sadatLine = sadatLine.reversed.toList();
      shohadaaLine = shohadaaLine.reversed.toList();
      directionForFirstRoute.writeln("Take Direction to Helwan and Change Direction at El-Sadat");
      directionForSecondRoute.writeln("Take Direction to Helwan and Change Direction at El-Shohadaa");
    ...
    if (endIndex < sadatIndexAtLine2 && endIndex < shohadaaIndexAtLine2) {
      ...
      subLine.clear();
      directionForFirstRoute.writeln("And Then Take Direction to ShobraEl-Kheima");
      directionForSecondRoute.writeln("And Then Take Direction to ShobraEl-Kheima");
      ...
      shohadaaLine.addAll(_metroLine2.sublist(shohadaaIndexAtLine2, endIndex + 1));
  ...
  void _searchRoutesFromLine2ToLine1() {
    ...
    if (_metroLine2.contains(start) && _metroLine1.contains(end)) {
      ...
      if (startIndex < sadatIndexAtLine2 && startIndex < shohadaaIndexAtLine2) {
        ...
        shohadaaLine.addAll(_metroLine2.sublist(startIndex, shohadaaIndexAtLine2));
        _directionForFirstRoute.write(
            'Take Direction to El-Mounib and Change Direction at El-Sadat \n');
        _directionForSecondRoute.write(
        ...
        sadatLine.addAll(_metroLine2.sublist(sadatIndexAtLine2 + 1, startIndex + 1));
        shohadaaLine.addAll(_metroLine2.sublist(shohadaaIndexAtLine2 + 1, startIndex + 1));
        sadatLine = sadatLine.reversed.toList();
        shohadaaLine = shohadaaLine.reversed.toList();
        _directionForFirstRoute.write(
            'Take Direction to ShobraEl-Kheima and Change Direction at El-Sadat \n');
        _directionForSecondRoute.write(
      ...
      if (endIndex < sadatIndexAtLine1 && endIndex < shohadaaIndexAtLine1) {
        ...
        shohadaaLine.addAll(_metroLine1.sublist(shohadaaIndexAtLine1, endIndex + 1));
        _directionForFirstRoute.write('And Then Take Direction to Helwan ');
        _directionForSecondRoute.write('And Then Take Direction to Helwan ');
